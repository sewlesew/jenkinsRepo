	...
	<section class="container">
		<form:form  modelAttribute="newCustomer" class="form-horizontal"  >
			<fieldset>
				...
				<div class="form-group">
					<label class="control-label col-lg-2" for="age">C</label>
					<div class="col-lg-10">
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<div class="form:input-prepend">
							<form:input  path="userCredentials.Groups[0].group_name" type="text" class="form:input-large"/>
							<form:errors path="userCredentials.Groups[0].group_name" cssClass="text-danger"/>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<div class="form:input-prepend">
							<form:input  path="userCredentials.Groups[0].authority[0].authority"  type="text" class="form:input-large"/>
							<form:errors path="userCredentials.Groups[0].authority[0].authority"  cssClass="text-danger"/>
						</div>
					</div>
				</div>

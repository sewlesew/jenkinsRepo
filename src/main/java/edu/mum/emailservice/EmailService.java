...
public class EmailService {
     ...
     private static final String IM_THE_GUY = "templates/images/hotel.jpg";
  ...
  @Autowired
     ...
     */
  @ServiceActivator()
  public MimeMessage handle(Customer customer) 
          throws MessagingException {
      
	  // Need to use your own recipient here
	  String recipientEmail = customer.getEmail();
	  String recipientName = customer.getFirstName();
	  	return handle( recipientName, recipientEmail, customer,null);
  
  		}
 
	    public MimeMessage  handle(
	            final String recipientName, final String recipientEmail, Customer customer,Locale locale) 
	            throws MessagingException {
        ...
        thymeContext.setVariable("customer", customer);
          
        // Prepare message using a Spring helper
        final MimeMessage mimeMessage = this.mailSender.createMimeMessage();
        final MimeMessageHelper message = new MimeMessageHelper(mimeMessage, true,"UTF-8");
        message.setSubject("Hotel Room Reserved..!");

...
import edu.mum.passwordEncoder.Encoder;
import edu.mum.domain.UserCredentials;
...
public class UserCredentialsServiceImpl implements edu.mum.service.UserCredentialsService {
    ...
    public void save( UserCredentials userCredentials) { 
    	...
    	userCredentials.setPassword(passwordEncoder.encodePassword(userCredentials.getPassword()));
    	userCredentials.setVerifyPassword(passwordEncoder.encodePassword(userCredentials.getVerifyPassword()));
